...
local recipe3 = {
  ...
  results = {
    ...
    { type = "item", name = "damaged-magnetic-packaging", amount = 25, independent_probability = constants.damaged_packaging_return_change, show_details_in_recipe_tooltip = false },
    { type = "item", name = "magnetic-packaging",         amount = 25, independent_probability = constants.undamaged_packaging_return_change, show_details_in_recipe_tooltip = false },
  }
}
