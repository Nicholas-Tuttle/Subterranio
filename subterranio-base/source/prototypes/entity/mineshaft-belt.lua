require("util")
local graphics = require("prototypes.graphics.mineshaft-belt-graphics")
...
local function create_mineshaft_belt_type(prefix, order_postfix, speed, tech, tint)
    ...
    return { object_up, object_down, item, item_up, item_down, recipe, recipe_up, recipe_down, recipe_up_from_down,
        recipe_down_from_up, tech }
end
...
-- TODO: Can this be part of the create_mineshaft_belt_type function so that it can be used generically?
data:extend {{
    type = "animation",
    name = "mineshaft-belt-graphics",
    filename = "__subterranio-base__/graphics/entity/mineshaft_belt/mineshaft_belt.png",
