...
tile.name = "water-resistant-cave-scaffolding"
tile.order = "d[subterrain]-c[water-resistant-cave-scaffolding]"
tile.subgroup = "special-tiles"
tile.minable = {
  mining_time = 0.5,
  result = "water-resistant-cave-scaffolding"
}
...
item.name = "water-resistant-cave-scaffolding"
item.order = "z[subterrain]-b[water-resistant-cave-scaffolding]"
item.place_as_tile =
{
  result = "water-resistant-cave-scaffolding",
  condition_size = 1,
  condition = { layers = {} },
  tile_condition = { "gleban-cave-wall" }
}
item.enabled = false
...
if mods["subterranio-nauvis"] then
  ingredients = {
    ...
    { type = "item", name = "mycellium",        amount = 5 },
  }
else
  ingredients = {
    ...
    { type = "item", name = "water-pipe",            amount = 1 },
    { type = "item", name = "mycellium",             amount = 5 },
  }
end
...
local recipe = {
  ...
  results = { { type = "item", name = "water-resistant-cave-scaffolding", amount = 1 } }
}
