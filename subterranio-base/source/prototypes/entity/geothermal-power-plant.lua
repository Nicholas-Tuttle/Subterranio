...
local graphics_animations = {
    layers = {
        {
            filename = "__subterranio-base__/graphics/entity/geothermal-powerplant/research-center-hr-animation-full.png",
            priority = "high",
            width = 4720 / 8,
            height = 6400 / 10,
        ...
        {
            filename = "__subterranio-base__/graphics/entity/geothermal-powerplant/research-center-hr-emission-full.png",
            priority = "high",
            width = 4720 / 8,
            height = 6400 / 10,
            frame_count = sprite_count,
        ...
        {
            filename = "__subterranio-base__/graphics/entity/geothermal-powerplant/research-center-hr-shadow.png",
            priority = "high",
            width = 1200,
            height = 700,
            frame_count = 1,
...
local entity = {
    ...
    icon = "__subterranio-base__/graphics/entity/geothermal-powerplant/research-center-icon-big.png",
    icon_size = 640,
    inventory_size = 1,
